...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [debugger addController:[PDNetworkDomainController defaultInstance]];
    [debugger addController:[PDDatabaseDomainController defaultInstance]];
    
    [[PDDatabaseDomainController defaultInstance] addManagedObjectContext:self.managedObjectContext];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    while (![__persistentStoreCoordinator addPersistentStoreWithType:NSSQLiteStoreType configuration:nil URL:storeURL options:nil error:&error])
    {
        /*
         Replace this implementation with code to handle the error appropriately.
