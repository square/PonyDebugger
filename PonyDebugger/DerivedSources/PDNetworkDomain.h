...
// Param stackTrace: JavaScript stack trace upon issuing this request.
// Param redirectResponse: Redirect response data.
- (void)requestWillBeSentWithRequestId:(NSString *)requestId frameId:(NSString *)frameId loaderId:(NSString *)loaderId documentURL:(NSString *)documentURL request:(PDNetworkRequest *)request timestamp:(NSNumber *)timestamp initiator:(PDNetworkInitiator *)initiator stackTrace:(NSArray *)stackTrace redirectResponse:(PDNetworkResponse *)redirectResponse;
...
@property (nonatomic, readonly, retain) PDNetworkDomain *networkDomain;
