...
- (void)domain:(PDDOMDomain *)domain setTouchEmulationEnabledWithEnabled:(NSNumber *)enabled callback:(void (^)(id error))callback;
...
@property (nonatomic, readonly, retain) PDDOMDomain *DOMDomain;
